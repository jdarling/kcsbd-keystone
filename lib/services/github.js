...
// Credentials
var credentials = {
	clientID: production ? '9efaa5849bb3368c463d' : '36d7113f26e499950d5f',
	clientSecret: production ? '2fb7189784a920329baaa896d2e7ead4066ebfe5' : '3b1ba755eceacc35c77e6c92270d9af57b7288c8',
	callbackURL: production ? 'http://www.kcsbd.org/authentication/github?callback' : 'http://localhost:3000/authentication/github?callback'
};
...
exports.authenticateUser = function(req, res, next, callback)
{
	...
	var createSydjsUser = function() {
		...
		console.log('[services.github] - Creating user...');
		console.log('------------------------------------------------------------');
		...
		console.log('[services.github] - user create data:', userData );

		// Create user
		data.sydjsUser = new User.model(userData);

		console.log('[services.github] - Created new instance of user.');
		console.log('------------------------------------------------------------');
	...
	var saveSydjsUser = function() {
		...
		console.log('[services.github] - Saving user...');
		console.log('------------------------------------------------------------');
		...
		console.log('[services.github] - user update data:', userData );
		...
		data.sydjsUser.save(function(err) {
			...
			if (err) {
				console.log(err);
				console.log("[services.github] - Error saving user.");
				console.log('------------------------------------------------------------');
				return callback(err);

			} else {

				console.log("[services.github] - Saved user.");
				console.log('------------------------------------------------------------');
	...
	var signinSydjsUser = function() {
		...
		console.log('[services.github] - Signing in user...');
		console.log('------------------------------------------------------------');
